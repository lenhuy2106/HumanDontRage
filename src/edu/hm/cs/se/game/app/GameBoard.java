...
/**
 * Representation of the internal game state.
 * Please don't change.
...
public class GameBoard {
    ...
    private final List<List<Field>> ends = new ArrayList<>();
